...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('get files', 'get', 'http://127.0.0.1:5000/api/gh_files_manager/branch/requests_test/'),
        ...
        ('delete file', 'get', 'http://127.0.0.1:5000/api/branch/requests_test/my-file.txt?commit_message="pytest"', 200),
        ('delete branch', 'delete', 'http://127.0.0.1:5000/api/branch/test/', 200),
     ]
)
